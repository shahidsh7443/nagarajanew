<?php if ( ! defined( 'ABSPATH' ) ) :
    ...
    class TT_Popular_Post_Widget extends WP_Widget {
        public function __construct() {
            parent::__construct(
                'fivegrid_popular_post', // Base ID
                __('Nominee Popular Posts', 'tt-pl-textdomain'), // Name
                        ...
                        $the_query->the_post(); ?>
                            <div class="media">
                                <?php
                                    ...
                                    $image = wp_get_attachment_image_src($thumb_id, 'nominee-popular-post-thumb'); // Get img URL.
                                    //
                                ...
                                <div class="media-body">
                                    <h4>
                                        ...
                                        <?php if ($instance[ 'post_view' ] == 'yes') : ?>
                                            <span>(<?php echo tt_get_post_views(get_the_ID()) ?>)</span>
                                        <?php endif; ?>
                                    </h4>
