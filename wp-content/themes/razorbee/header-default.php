...
<div class="col-lg-1 col-md-2 col-sm-2 col-xs-2" style="display:inline-block;float:left;">
       ...
       <div class="col-lg-2 col-md-3 col-sm-4 col-xs-5" style="display:inline-block;float:left;">
                              <a href="<?php echo $rurl?>" title="Nagaraja Rao">
                                      <img class="hidden-xs img1" src="<?php echo $rurl?>/wp-content/uploads/2015/12/word.png" data-at2x="<?php echo $rurl?>/wp-content/uploads/2015/12/word.png" alt="Nagaraja Rao">
                                    <img style="height: 35px;width:auto;padding-top: 10px;margin-top: 0px;" class="visible-xs trp" src="<?php echo $rurl?>/wp-content/uploads/2015/12/word.png" data-at2x="<?php echo $rurl?>/wp-content/uploads/2015/12/word.png" alt="Nagaraja Rao">
     </a>
                  </div>
